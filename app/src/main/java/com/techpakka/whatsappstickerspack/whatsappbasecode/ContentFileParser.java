...
public class ContentFileParser {
    ...
    @NonNull
    public static ArrayList<StickerPack> parseStickerPacks(@NonNull InputStream contentsInputStream) throws IOException, IllegalStateException {
    ...
    @NonNull
    private static ArrayList<StickerPack> readStickerPacks(@NonNull JsonReader reader) throws IOException, IllegalStateException {
