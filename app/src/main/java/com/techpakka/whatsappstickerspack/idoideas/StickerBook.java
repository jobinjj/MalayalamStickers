...
public class StickerBook {
    ...
    public static void init(Context context){
        myContext = context;
        ArrayList<StickerPack> lsp = DataArchiver.readStickerPackJSONFromSharedPref(context);
    ...
    public static void addStickerPackExisting(StickerPack sp, Context context){
        allStickerPacks.add(sp);
        DataArchiver.writeStickerBookJSON(allStickerPacks,context);
    }
