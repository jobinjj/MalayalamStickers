...
public class MarketStickerPreviewAdapter extends RecyclerView.Adapter<MarketStickerPreviewAdapter.StickerPreviewViewHolder> {
    ...
    @NonNull
    private final List<Stickers> stickersList;
    ...
    public MarketStickerPreviewAdapter(
            ...
            @NonNull final List<Stickers> stickersList, Context context) {
    ...
    public void onBindViewHolder(@NonNull final StickerPreviewViewHolder stickerPreviewViewHolder, final int i) {
        ...
        Glide.with(context.getApplicationContext()).load(stickersList.get(i).getStickerUrl()).into(stickerPreviewViewHolder.stickerPreviewView);
    }

    @Override
    public int getItemCount() {
        int numberOfPreviewImagesInPack;
        numberOfPreviewImagesInPack = stickersList.size();
        if (cellLimit > 0) {
